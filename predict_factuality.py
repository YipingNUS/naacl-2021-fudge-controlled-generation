...
def predict_factuality(model, tokenizer, conditioning_model, input_text, precondition_topk=200, do_sample=False,
    ...
    with torch.no_grad():
        ...
        # Yiping: modified this line. 65000 was the <pad> token. That tokenizer doesn't have bos token.
