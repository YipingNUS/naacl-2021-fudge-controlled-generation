...
def predict_factuality(model, tokenizer, conditioning_model, input_text, precondition_topk=200, do_sample=False, length_cutoff=512, condition_lambda=1.0, device='cuda'):
    with torch.no_grad():
